...
if __name__ == '__main__':
    ...
    parser.add_argument('--rate', type=int, default=48000, help='Sample rate (optional)')
    ...
    record = Record(args.backend, args.device, args.rate, args.blocksize, args.channels)
    print('Recording...')
